...
const Banner = () => {
  return (
    <div className="lg:flex md:justify-around bg-green-900 bg-gradient-to-r from-green-999 via-green-800 text-white items-center py-12 my-8 md:my-12 px-10 opacity-90">
      <div className="py-5">
