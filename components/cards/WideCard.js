...
const WideCard = ({ card, order }) => {
  return (
    <div className="md:grid md:grid-cols-2 justify-between align-middle place-items-center py-6 md:py-0">
      <div className="flex justify-between items-center">
        <Image alt='HSC logo' src={card.img} width={791} height={390} />
      </div>
      <div className={`col-span-1 ${order} align-center px-4 md:px-20`}>
